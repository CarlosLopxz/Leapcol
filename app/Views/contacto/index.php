        ...
        <div class="row g-8 mb-16">
            ...
            <div class="col-12 col-md-4">
                <div class="text-center h-100 p-8 bg-white rounded-4 shadow-sm transition-all"
                    ...
                    <a href="https://wa.me/573018467581?text=¡Hola!%20Necesito%20información%20sobre%20Leapcol"
                        target="_blank"
                    ...
                    <p class="mt-3 mb-0 text-secondary fs-11">+57 301 846 7581</p>
                </div>
            </div>
            ...
            <div class="col-12 col-md-4">
                <div class="text-center h-100 p-8 bg-white rounded-4 shadow-sm transition-all"
                    ...
                    <a href="mailto:leapcol.soporte@gmail.com"
                    ...
                    <p class="mt-3 mb-0 text-secondary fs-11">leapcol.soporte@gmail.com</p>
                </div>
            </div>
        ...
        <div class="row g-8 justify-content-center">
            ...
            <div class="col-12 col-md-4">
                <div class="text-center p-6">
                    ...
                    <p class="mb-2 fs-9 fw-medium text-secondary">Sábados y Domingos: 9:00 AM - 5:00 PM</p>
...
<style>
    ...
    .form-control:focus,
    .form-select:focus {
        ``` style="transition: all 0.3s ease; border: 1px solid #f1f3f5;"><div class="mb-6 d-flex justify-content-center align-items-center mx-auto text-white bg-primary rounded-circle"
        style="width: 80px; height: 80px;"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22 16.92V19.92C22 20.4696 21.5523 20.9173 21.0027 20.9201C18.0571 20.9483 15.1693 20.1134 12.6597 18.5084C10.3214 17.0289 8.39389 14.9885 7.04229 12.5644C5.49539 10.0432 4.70595 7.14477 4.75 4.2C4.75224 3.65023 5.19989 3.20258 5.75 3.20258H8.75C9.02614 3.20258 9.25 3.42644 9.25 3.70258C9.25 5.63258 9.61 7.48258 10.28 9.19258C10.36 9.40258 10.29 9.64258 10.11 9.78258L8.47 11.09C9.95 13.5 11.95 15.5 14.37 16.98L15.68 15.34C15.82 15.16 16.06 15.09 16.27 15.17C17.98 15.84 19.83 16.2 21.76 16.2C22.0361 16.2 22.26 16.4239 22.26 16.7V19.7C22.26 20.2496 21.8123 20.6973 21.2627 20.7001L22 16.92Z"
        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></svg></div><h3 class="font-heading fs-8 mb-3">Teléfono</h3><p class="mb-4 fw-medium text-secondary fs-9">Llámanos de lunes a viernes </p><a href="tel:+573018467581"
        class="btn btn-primary px-6 py-3 fs-10 fw-medium rounded shadow text-white d-inline-flex align-items-center gap-2"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
        stroke-width="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" /></svg>Llamar Ahora </a><p class="mt-3 mb-0 text-secondary fs-11">+57 301 846 7581</p></div></div></div></div></section>< !-- Formulario de Contacto --><section class="position-relative py-20 bg-light overflow-hidden"><div class="container"><div class="row justify-content-center"><div class="col-12 col-lg-8"><div class="bg-white rounded-4 shadow-sm p-10"><div class="text-center mb-10"><h2 class="font-heading mb-4 fs-5" style="letter-spacing: -1px;">Envíanos un mensaje </h2><p class="mb-0 fs-9 fw-medium text-secondary">Completa el formulario y nos pondremos en contacto contigo lo antes posible. </p></div><form id="contactForm" action="<?= base_url('contacto/enviar') ?>" method="POST"><div class="row g-6">< !-- Nombre --><div class="col-12 col-md-6"><label for="nombre" class="form-label fs-9 fw-medium text-dark">Nombre completo *</label><input type="text" class="form-control py-3 fs-9" id="nombre" name="nombre"
        placeholder="Tu nombre" required></div>< !-- Email --><div class="col-12 col-md-6"><label for="email" class="form-label fs-9 fw-medium text-dark">Email *</label><input type="email" class="form-control py-3 fs-9" id="email" name="email"
        placeholder="tu@email.com" required></div>< !-- Teléfono --><div class="col-12 col-md-6"><label for="telefono" class="form-label fs-9 fw-medium text-dark">Teléfono</label><input type="tel" class="form-control py-3 fs-9" id="telefono" name="telefono"
        placeholder="+57 300 123 4567"></div>< !-- Empresa --><div class="col-12 col-md-6"><label for="empresa" class="form-label fs-9 fw-medium text-dark">Empresa</label><input type="text" class="form-control py-3 fs-9" id="empresa" name="empresa"
        placeholder="Nombre de tu empresa"></div>< !-- Asunto --><div class="col-12"><label for="asunto" class="form-label fs-9 fw-medium text-dark">Asunto *</label><select class="form-select py-3 fs-9" id="asunto" name="asunto" required><option value="">Selecciona un asunto</option><option value="informacion">Solicitar información</option><option value="demo">Solicitar demo</option><option value="soporte">Soporte técnico</option><option value="ventas">Consulta de ventas</option><option value="otro">Otro</option></select></div>< !-- Mensaje --><div class="col-12"><label for="mensaje" class="form-label fs-9 fw-medium text-dark">Mensaje *</label><textarea class="form-control fs-9" id="mensaje" name="mensaje" rows="5"
        placeholder="Cuéntanos cómo podemos ayudarte..." required></textarea></div>< !-- Botón Submit --><div class="col-12"><button type="submit"
        class="btn btn-danger w-100 py-4 fs-9 fw-medium rounded shadow text-white">Enviar mensaje </button></div><div class="col-12"><p class="mb-0 text-center text-secondary fs-11">* Campos obligatorios. Al enviar este formulario aceptas nuestra política de privacidad. </p></div></div></form></div></div></div></div></section><section class="position-relative py-20 bg-white overflow-hidden"
        style="background-image: url('euphoria-assets/elements/pattern-light.png')"><div class="position-absolute top-0 start-0 h-100 w-100"
        style="background: radial-gradient(50% 50% at 50% 50%, rgba(255, 255, 255, 0) 0%, #FFFFFF 100%);"></div><div class="position-relative container" style="z-index:1;"><div class="row g-8 justify-content-center">< !-- Horarios --><div class="col-12 col-md-4"><div class="text-center p-6"><div class="mb-4 d-flex justify-content-center align-items-center mx-auto text-white bg-danger rounded-circle"
        style="width: 60px; height: 60px;"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" /><path d="M12 6V12L16 14" stroke="currentColor" stroke-width="2" stroke-linecap="round" /></svg></div><h3 class="font-heading fs-8 mb-3">Horarios de atención</h3><p class="mb-2 fs-9 fw-medium text-secondary">Lunes a Viernes: 8:00 AM - 6:00 PM</p> <p class="mb-2 fs-9 fw-medium text-secondary" >Sábados y Domingos: 9:00 AM - 5:00 PM</p> <p class="mb-0 fs-9 fw-medium text-danger" >Soporte 24/7 por WhatsApp</p> </div> </div> < !-- Redes Sociales --> <div class="col-12 col-md-4" > <div class="text-center p-6" > <div class="mb-4 d-flex justify-content-center align-items-center mx-auto text-white bg-danger rounded-circle"
            ...
            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /> </svg> </div> <h3 class="font-heading fs-8 mb-3" >Síguenos</h3> <div class="d-flex justify-content-center gap-3" > <a href="#"
            class="btn btn-outline-danger btn-sm rounded-circle d-flex align-items-center justify-content-center"
            style="width: 50px; height: 50px;" > <svg width="30" height="30" viewBox="0 0 24 24" fill="currentColor" > <path d="M18 2h-3c-1.326 0-2.598.527-3.536 1.464C10.527 4.402 10 5.674 10 7v3H7v4h3v8h4v-8h3l1-4h-4V7c0-.265.105-.52.293-.707C14.48 6.105 14.735 6 15 6h3V2z" /> </svg> </a> <a href="#"
            class="btn btn-outline-danger btn-sm rounded-circle d-flex align-items-center justify-content-center"
            style="width: 50px; height: 50px;" > <svg width="30" height="30" viewBox="0 0 24 24" fill="currentColor" > <path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z" /> </svg> </a> <a href="#"
            class="btn btn-outline-danger btn-sm rounded-circle d-flex align-items-center justify-content-center"

            style="width: 50px; height: 50px;" > <svg width="30" height="30" viewBox="0 0 24 24" fill="currentColor" > <rect x="2" y="2" width="20" height="20" rx="5" ry="5" /> <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" fill="white" /> <line x1="17.5" y1="6.5" x2="17.51" y2="6.5" stroke="white" stroke-width="2" /> </svg> </a> </div> </div> </div> </div> </div> </section> <style> .transition-all:hover {
            transform: translateY(-5px);
            box-shadow: 0 12px 24px rgba(0, 0, 0, 0.08) !important;
            border-color: #dbeafe !important;
        }
