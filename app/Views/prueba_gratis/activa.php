        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8">
                <div class="bg-white rounded-4 shadow-lg p-8 p-lg-12 text-center">
                    ...
                    <!-- Header -->
                    <div class="mb-8">
                        <span class="badge bg-warning text-dark shadow text-uppercase fs-13 fw-medium mb-4">Prueba Activa</span>
                        <h1 class="font-heading fs-4 mb-4" style="letter-spacing: -1px;">
                            Ya tienes una prueba activa de <span class="text-danger"><?= esc($producto['nombre']) ?></span>
                        </h1>
                        <p class="fs-9 fw-medium text-secondary mb-0">
                            Tu prueba expira el <strong><?= date('d/m/Y', strtotime($prueba['fecha_expiracion'])) ?></strong>
                        </p>
                    </div>
