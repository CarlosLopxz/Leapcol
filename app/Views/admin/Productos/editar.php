                            ...
                            <div>
                                <div class="btn-wrapper">
                                    <a href="<?= base_url('admin/productos') ?>"
                                        class="btn btn-secondary text-white me-0">
                                ...
                                <div class="row">
                                    <div class="col-12 grid-margin stretch-card">
                                        <div class="card card-rounded">
                                            <div class="card-body">
                                                <form
                                                    action="<?= base_url('admin/productos/actualizar/' . $producto['id']) ?>"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="file" class="form-control"
                                                                    ...
                                                                    accept="image/*">
                                                                <small class="text-muted">Dejar vacío para mantener la
                                                                    imagen actual</small>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" id="estado" name="estado">
                                                                    ...
                                                                    <option value="inactivo"
                                                                        <?= $producto['estado'] == 'inactivo' ? 'selected' : '' ?>>Inactivo</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        if (!empty($imagenesAdicionales)):
                                                            ...
                                                            <div class="d-flex gap-2 mb-2 flex-wrap">
                                                                <?php foreach ($imagenesAdicionales as $img): ?>
                                                                    <img src="<?= base_url('public/assets/img/productos/' . $img) ?>"
                                                                        alt="Imagen adicional" class="img-thumbnail"
                                                                        style="height: 60px; width: 60px; object-fit: cover;">
                                                                <?php endforeach; ?>
                                                            </div>
                                                        <?php endif; ?>
                                                        <input type="file" class="form-control"
                                                            id="imagenes_adicionales" name="imagenes_adicionales[]"
                                                            accept="image/*" multiple>
                                                        <small class="text-muted">Las nuevas imágenes se agregarán a las
                                                            existentes</small>
                                                    </div>

                                                    <div class="form-check">
                                                        <input type="checkbox" class="form-check-input" id="mas_vendido"
                                                            name="mas_vendido" value="1" <?= $producto['mas_vendido'] ? 'checked' : '' ?>>
