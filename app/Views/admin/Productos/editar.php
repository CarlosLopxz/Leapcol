                                ...
                                <div class="row">
                                    <div class="col-12 grid-margin stretch-card">
                                        <div class="card card-rounded">
                                            <div class="card-body">
                                                <form action="<?= base_url('admin/productos/actualizar/' . $producto['id']) ?>" method="POST">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" step="0.01" class="form-control" id="precio_oferta" 
                                                                       name="precio_oferta" value="<?= $producto['precio_oferta'] ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="imagen_principal" 
                                                                       name="imagen_principal" value="<?= $producto['imagen_principal'] ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
